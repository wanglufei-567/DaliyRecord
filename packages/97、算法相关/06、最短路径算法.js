...
/**
 * 最短路径算法是一种解决从一个节点到另一个节点的最短路径问题的算法
 *
 * 图数据结构示意图：
 *         A ────────── B ────────── E ────────── I
 *         │╲           │
 ...
 * 直到访问完所有顶点为止
 *
 * 因为广度优先搜索的特性，每个顶点只会被访问一次，所以不会出现重复计算距离的情况，
 * 也就是说每个顶点到起始顶点的距离都是最短的，这就是最短路径算法的核心思想
  ...
  while (queue.length > 0) {
    ...
    for (let i = 0; i < neighbors.length; i++) {
      ...
      if (color[w] === Colors.WHITE) {
         ...
         * 以此类推
         * 需要注意的是，得益于上色系统的设计，每个顶点只会被访问一次，所以不会出现重复计算距离的情况
         */
